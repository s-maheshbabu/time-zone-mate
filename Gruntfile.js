module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      build: {
        files: [
          {
            cwd: 'src',
            src: ['index.html', 'about.html', 'blog/**', 'alexa/**', 'app/**/*.js', 'assets/libs/**', 'assets/fonts/**', 'assets/data/podunksToTimeZones.json' ],
            dest: 'build',
            expand: true
          },
          {
    ...
    watch: {
      copy: {
        files: [ 'src/index.html', 'src/about.html', 'src/blog/**', 'src/alexa/**', 'src/app/**/*.js', 'src/assets/libs/**', 'src/assets/data/podunksToTimeZones.json', 'src/assets/fonts/**' ],
        tasks: [ 'copy' ]
      },
      scripts: {
        files: 'src/app/**/*.js',
